...
-- select*from users where date_of_birth>'1995-05-14';
-- select*from users where gender = 'male' and salary>'60,000';
-- select *from users where gender ='male'or gender =  'female';
-- select*from users where gender = 'male' order by date_of_birth desc limit 8;